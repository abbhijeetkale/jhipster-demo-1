...
import { Jhipsterdemo1AdminModule } from 'app/admin/admin.module';
import {
    BlogComponent,
    BlogDetailComponent,
    BlogUpdateComponent,
...
@NgModule({
    imports: [Jhipsterdemo1SharedModule, Jhipsterdemo1AdminModule, RouterModule.forChild(ENTITY_STATES)],
...
export class Jhipsterdemo1BlogModule {}
